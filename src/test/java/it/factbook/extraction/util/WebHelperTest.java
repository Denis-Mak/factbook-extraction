...
public class WebHelperTest {
    ...
    public void testGetDecodedURL() throws Exception {
        ...
        assertEquals("https://www.scribd.com/doc/77147329/Английский-язык-Учебник-устного-перевода", WebHelper.decodeURL(rawUrl));
        assertEquals("/2012/05/17/п-дж-бьюкенен/", WebHelper.decodeURL(utf8EncodedUrl));
        assertEquals("http://www.lib.unn.ru/php/catalog.php?Index=1&Letter=%CF&DB=1", WebHelper.decodeURL(win1251EncodedUrl));
    }
}